 ...
 */
public class ScanPay extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                add.putExtra("productId",product_id);
    ...
    public void onClick(View v) {
        if(v.getId()== R.id.scan_button){
            ...
            product_id.remove(product_id.size()-1);
            int len = amount.size()-1;
            total_cost -= Integer.parseInt(amount.get(len));
    ...
    public void getData(String v1){
        ...
        try{
            ...
            if(ch.equals("success"))
            {
                ...
                int id = no.getInt("product_id");
                String productId = NumberFormat.getInstance().format(id);
                editText1.setText(w);
